...
// Check if the cluster is a worker or the master process.
// Worker being a independent process, like the API, Pool, etc.
// Just not everything at once, running in the same process.
...
var singleModule = (function(){
    ...
    var validModules = ['pool', 'api', 'payments', 'chartsDataCollector'];
